...
/**
  ...
  * Time: 10:41
  */
class ReplyPost(board:String,topicId:Long,quoteId:Long) extends Index {
  override val locationHashString="#/ReplyPost"
  var titleValue="回复："
  var contentValue=""
  def postArticle={
    val bodyStr = UserReplyPost(board,topicId,quoteId,titleValue,contentValue).asJson.noSpaces
    ...
    <div>
      ...
      <div class="pure-u-3-4 pure-form pure-form-aligned" style="paddingTop:60px">
        <div class="pure-control-group">
          <label>标题</label>
          <input class="pure-input-1" value="回复：" onchange={ (e: Event) =>
